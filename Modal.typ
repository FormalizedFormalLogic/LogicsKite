...
#raw-render(
  ...
  labels: (
    ...
    "LO.Modal.Logic.GrzDot2M": $Logic("Grz.2M")$,
    "LO.Modal.Logic.GrzDot3": $Logic("Grz.3")$,
    "LO.Modal.Logic.K": $Logic("K")$,
    "LO.Modal.Logic.K4": $Logic("K4")$,
    "LO.Modal.Logic.K45": $Logic("K45")$,
    "LO.Modal.Logic.K4Dot1": $Logic("K4.1")$,
    "LO.Modal.Logic.K4Dot2": $Logic("K4.2")$,
    "LO.Modal.Logic.K4Dot2Z": $Logic("K4.2Z")$,
    "LO.Modal.Logic.K4Dot3": $Logic("K4.3")$,
    "LO.Modal.Logic.K4Dot3Z": $Logic("K4.3Z")$,
    ...
    "LO.Modal.Logic.S4Dot1": $Logic("S4.1")$,
    "LO.Modal.Logic.S4Dot2": $Logic("S4.2")$,
    "LO.Modal.Logic.S4Dot3": $Logic("S4.3")$,
    "LO.Modal.Logic.S4Dot4": $Logic("S4.4")$,
    "LO.Modal.Logic.S4Dot2Dot4M": $Logic("S4.2.4M")$,
    "LO.Modal.Logic.S4Dot9": $Logic("S4.4") + Axiom("M18")$,
    ...
    "LO.Modal.Logic.S4Dot2M": $Logic("S4.2M")$,
    "LO.Modal.Logic.DumDot2": $Logic("Dum.2")$,
    "LO.Modal.Logic.DumDot3": $Logic("Dum.3")$,
  ),
  width: 480pt,
)
